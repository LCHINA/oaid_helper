...
/**
 * @ClassName MiitHelperProxy1_0_13
 * @Description 针对1.0.13版本获取Oaid
 * @Author lchinali
 * @Date 3/8/21 11:30 PM
 * @Version 1.0
 */

class OaidHelperProxy1_0_13 extends Oaid {
    public static String TAG = OaidHelperProxy1_0_13.class.getName();
    ...
    public OaidHelperProxy1_0_13(OaidHelper.AppIdsUpdater callback, ClassLoader loader) {
